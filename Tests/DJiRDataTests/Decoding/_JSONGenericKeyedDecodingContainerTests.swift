...
class _JSONGenericKeyedDecodingContainerTests: XCTestCase {
    ...
    var notSupportedContainer: Legacy._JSONGenericKeyedDecodingContainer<TwoKeys> {
    ...
    func testInit_CodingPath_IsSet() {
        ...
        let container = Legacy._JSONGenericKeyedDecodingContainer<TwoKeys>(data: [:], codingPath: codingPath)
    ...
    func testInit_AllKeys_IsSet() {
        let data: [String: Legacy.JSONGenericModel.Value] = [
            TwoKeys.aKey.stringValue: .init(stringValue: ""),
            TwoKeys.notherKey.stringValue: .init(stringValue: "")
        ]
        
        let container = Legacy._JSONGenericKeyedDecodingContainer<TwoKeys>(data: data, codingPath: [])
    ...
    func testDecode_String_ThrowsKeyNotFound() {
        ...
        do {
            _ = try Legacy._JSONGenericKeyedDecodingContainer<TwoKeys>(data: data, codingPath: [TwoKeys.aKey])
    ...
    func testDecode_Double_ThrowsTypeMismatch() {
        ...
        do {
            _ = try Legacy._JSONGenericKeyedDecodingContainer<TwoKeys>(data: data, codingPath: [TwoKeys.notherKey])
